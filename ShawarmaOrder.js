  ...
  handleInput(sInput) {
    ...
    switch (this.stateCur) {
      ...
      case OrderState.DRINKS:
        if (
          ["milkshake", "vietnam coffee", "coconut juice"].includes(
            sInput.toLowerCase()
          )
        ) {
          ...
          this.stateCur = OrderState.DRINKS;
          aReturn.push(
            "Please enter a valid drink: Milkshake, Vietnam Coffee or Coconut Juice."
          );
        }
  ...
  renderForm(sTitle = "-1", sAmount = "-1") {
    ...
    return `
      ...
      <body>
        ...
        Thank you ${this.sNumber} for your ${this.sItem} order of $${this.finalPrice}.
